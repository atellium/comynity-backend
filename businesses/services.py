...
def seed_businesses(records):
    ...
    writable = {"name", "slug", "established_year", "offerings", "address", "landmark", "locality", "postal_code", "latitude", "longitude", "phone", "whatsapp", "email", "website", "status", "is_active", "is_verified", "display_full_address", "display_business_hours"}
    ...
    accepted = writable | profile_fields | set(profile_aliases) | {"id", "owner", "categories", "city", "published_at"}
...
def business_response_queryset(
    *, include_detail_data=False, include_all_offers=False, now=None
    ...
    response_fields = ("id", "owner_id", "name", "slug", "established_year", "offerings", "sections", "cover_image_id", "address", "landmark", "locality", "city_id", "postal_code", "location", "phone", "whatsapp", "email", "website", "status", "is_active", "is_verified", "display_full_address", "display_business_hours", "published_at", "created_at", "updated_at")
    ...
    queryset = Business.objects.only(
        ...
        *profile_fields,
        ...
        "city__state__name",
        "cover_image__id",
        "cover_image__object_key",
        "cover_image__mime_type",
        "cover_image__size",
        "cover_image__title",
        "cover_image__status",
        "cover_image__created_at",
        "cover_image__updated_at",
    ).select_related("city", "city__state", "profile", "cover_image")
...
def get_business_for_update(slug):
    from businesses.models import Business
    return Business.objects.select_related("owner", "city", "city__state", "profile", "cover_image").prefetch_related("categories", "business_hours", "gallery").filter(slug=slug).first()
