...
Owner-editable fields include business information, categories, location, contact details, media, `is_active`, visibility preferences, and SEO metadata. Publication status, verification state, ownership, slug, and system metadata cannot be changed through this endpoint.
