...
class BusinessGalleryAPITests(SimpleTestCase):
    ...
    def test_cover_image_is_returned_as_url_inside_media(self):
        business = Business(
            cover_image=Upload(
        ...
        media = BusinessListSerializer().get_media(business)

        self.assertIsInstance(media["cover_image"], str)
        self.assertTrue(
            media["cover_image"].endswith(
